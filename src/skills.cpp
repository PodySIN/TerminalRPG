...
rpg::BaseAttack::BaseAttack() : rpg::BaseAttack(1.0f, 0.0f, ScaleType::Damage)
{
}

void rpg::BaseAttack::doProcessSkill(Actor* owner, Actor* target)
{
  float attack = owner->getDamageManager().calculateOutputDamage(this);
...
rpg::ParryAttack::ParryAttack() : ParryAttack(0.75f, ScaleType::Damage)
{
}
